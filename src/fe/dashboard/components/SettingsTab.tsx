...
import PayoutSettingsCard from "./settings/PayoutSettingsCard";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start max-w-5xl" style={{ gap: "1.5rem" }}>
      <div className="flex flex-col gap-6">
        ...
        <PayoutSettingsCard settingsForm={settingsForm} setSettingsForm={setSettingsForm} onSaveSettings={onSaveSettings} />
      </div>
      <div className="flex flex-col gap-6">
